...
void helpMenu()
{
	...
	std::cout << "\nFiles must be of format \".txt\"\n" << std::endl;
	std::cout << "Encryption/decryption key prompt accepts any valid integer.\n" << std::endl;
	std::cout << "The encrypted/decrypted file is created in the same directory as the"<< std::endl;
	...
	std::cout << "\nIf a file of that name already exists, its contents are overwritten." << std::endl;
	std::cout << "--------------------------------------------------------------------" << std::endl;
}
